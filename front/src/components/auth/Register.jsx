...
export default function RegisterPage() {
	...
	return (
		<div className="flex min-h-screen bg-white font-sans text-slate-900 antialiased">
			<DoodleBackground />
			...
			<div className="relative hidden w-0 flex-1 lg:block">
				...
				<div className="absolute bottom-0 left-0 p-12 text-white">
					...
					<h2 className="text-3xl font-bold tracking-tight">Join the Stay Circle</h2>
					<p className="mt-2 max-w-md text-lg text-gray-200">Create your account to discover and book great stays worldwide.</p>
				</div>
			</div>
