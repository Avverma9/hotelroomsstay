...
router.post('/booking/:bookingId/cancel/send-otp', auth, bookingController.sendCancellationOtp);
router.post('/booking/:bookingId/cancel/verify', auth, bookingController.verifyCancellationOtpAndCancel);

router.get('/get/all/users-filtered/booking/by', auth, bookingController.getAllFilterBookings); // using on main site
